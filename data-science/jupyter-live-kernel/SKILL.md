...
## Programmatic Notebook Editing (No Kernel)

When you need to fill in template cells or prepare a clean submission without a
running kernel, modify the `.ipynb` JSON directly by cell `id`. See:
[references/programmatic-notebook-editing.md](references/programmatic-notebook-editing.md)
